...
# 작심 일일 코딩 2022.7.21 (목) 끝.

# 작심 일일 코딩 2022.7.23 (토) 시작
# 주석
# 실제로 실행을 할 때에는 주석 부분을 무시하게 됨
# 개발자와의 소통
# 복잡한 코딩에 대한 설명
# 작은따옴표를 세개 입력하면 주석처리 됨
# ''' 이렇게 하면
# 여러 문장이
# 주석처리 됩니다.'''
# 또는 ctr + /
...
# 작심 일일 코딩 2022.7.23 (토) 끝.

# 작심 일일 코딩 2022.7.24 (일) 시작
...
# 작심 일일 코딩 2022.7.24 (일) 끝.

# 작심 일일 코딩 2022.7.31 (일) 시작
# 연산자
